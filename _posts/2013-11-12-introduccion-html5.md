...
---
<figure>
<a href="/assets/img/2013/11/Introducción-a-HTML51.png"><amp-img layout="responsive" src="/assets/img/2013/11/Introducción-a-HTML51.png" title="{{ page.title }}" alt="{{ page.title }}" width="512px" height="512px" /></a>
</figure>
...
<figure>
<a href="/assets/img/2013/11/Introducción-a-HTML5.png"><amp-img layout="responsive" src="/assets/img/2013/11/Introducción-a-HTML5.png" title="{{ page.title }}" alt="{{ page.title }}" width="481px" height="409px" /></a>
</figure>
