...
<figure>
<amp-img src="/assets/img/2013/05/latex_logo.png" title="{{ page.title }}" alt="{{ page.title }}" width="300px" height="114px" />
</figure>
...
<figure>
<a href="/assets/img/xcolorlatex1.png"><amp-img src="/assets/img/xcolorlatex1.png" title="{{ page.title }}" alt="{{ page.title }}" width="300px" height="154px" /></a>
...
<figure>
<a href="/assets/img/xcolorlatex2.png"><amp-img src="/assets/img/xcolorlatex2.png" title="{{ page.title }}" alt="{{ page.title }}" width="300px" height="142px" /></a>
<span class="image-credit">Crédito de la imagen: texblog.org</span>
</figure>
...
<figure>
<a href="/assets/img/xcolorlatex3.png"><amp-img src="/assets/img/xcolorlatex3.png" title="{{ page.title }}" alt="{{ page.title }}" width="300px" height="156px" /></a>
<span class="image-credit">Crédito de la imagen: texblog.org</span>
</figure>
...
<figure>
<a href="/assets/img/latexxcolorbrillantes.png"><amp-img src="/assets/img/latexxcolorbrillantes.png" title="{{ page.title }}" alt="{{ page.title }}" width="1024px" height="291px" /></a>
<span class="image-credit">Crédito de la imagen: texblog.org</span>
</figure>
