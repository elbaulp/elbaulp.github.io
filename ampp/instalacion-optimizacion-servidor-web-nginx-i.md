...
<figure>
<a href="/assets/img/2014/02/instalacionNginx.png"><amp-img src="/assets/img/2014/02/instalacionNginx.png" title="{{ page.title }}" alt="{{ page.title }}" width="554px" height="192px" /></a>
</figure>
