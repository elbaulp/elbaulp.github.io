...
<pre lang="latex">\section{Código del programa}</pre>
...
<pre lang="latex">\usepackage{minted} % para resaltar código fuente</pre>
...
<pre lang="latex">cout &lt;&lt; "Hola mundo" &lt;&lt; endl;
return 0;
</pre>
...
<pre lang="latex">\micodigofuente[label="nombredemifichero.extension"]{nombredemifichero.extension}
</pre>
...
<pre lang="latex">\mycplusplus[label="postfija.h"]{postfija.h}
</pre>
...
<pre lang="latex">\subsection{Conclusión}
