...
lastmod: 2016-05-24T10:00:00+00:00
categories:
...
tags: [modificar el Prompt de bash, prompts con git, información de git prompts, instalar oh my git, configurar oh my git, configurar rainbow bash, instalar rainbow bash, git]
