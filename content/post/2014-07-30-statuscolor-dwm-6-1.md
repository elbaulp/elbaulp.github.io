...
description: Días atrás hablamos sobre DWM y quedó pendiente explicar cómo colorear
  la barra de estado. En el artículo de hoy veremos cómo aplicar el parche Simple
  StatusColor en DWM 6.1, que escribí hace poco.
...
<figure>
<a href="/assets/img/2014/07/simplestatuscolor-in-dwmstatus-dwm6.1.png"><amp-img on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="/assets/img/2014/07/simplestatuscolor-in-dwmstatus-dwm6.1.png" title="{{ page.title }}" alt="{{ page.title }}" width="702px" height="13px" /></a>
</figure>
