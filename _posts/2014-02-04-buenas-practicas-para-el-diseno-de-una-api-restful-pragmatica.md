...
<figure>
<a href="/assets/img/2014/01/201305-xml-vs-json-api.png"><amp-img on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="/assets/img/2014/01/201305-xml-vs-json-api.png" title="{{ page.title }}" alt="{{ page.title }}" width="817px" height="237px" /></a>
</figure>
<p>
