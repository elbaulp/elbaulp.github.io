...
<pre lang="java" >package com.example.adapter;
...
<pre lang="java">private OnClickListener checkListener = new OnClickListener()
{
...
<pre lang="java">holder.cb.setOnClickListener(checkListener);</pre>
...
<pre lang="java">public void setCheck(int position)
{
   PostData d = data.get(position);
...
<div class="sharedaddy">
  <div class="sd-content">
    <ul>
      <li>
        <a class="hastip" rel="nofollow" href="http://twitter.com/home?status=CustomAdapter+http://elbauldelprogramador.com/?post_type=dlm_download&p=2159+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Twitter" target="_blank"><span class="iconbox-title"><i class="icon-twitter icon-2x"></i></span></a>
      </li>
      <li>
        <a class="hastip" rel="nofollow" href="http://www.facebook.com/sharer.php?u=http://elbauldelprogramador.com/?post_type=dlm_download&p=2159&t=CustomAdapter+http://elbauldelprogramador.com/?post_type=dlm_download&p=2159+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Facebook" target="_blank"><span class="iconbox-title"><i class="icon-facebook icon-2x"></i></span></a>
      </li>
      <li>
        <a class="hastip" rel="nofollow" href="https://plus.google.com/share?url=CustomAdapter+http://elbauldelprogramador.com/?post_type=dlm_download&p=2159+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en G+" target="_blank"><span class="iconbox-title"><i class="icon-google-plus icon-2x"></i></span></a>
      </li>
    </ul>
  </div>
</div>
