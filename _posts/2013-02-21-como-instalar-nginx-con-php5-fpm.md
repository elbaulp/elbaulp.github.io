...
color: "#0097A7"
---
<img src="/assets/img/2013/02/nginx-logo.png" alt="instalar y configurar nginx"   />  
...
[<img src="/assets/img/2013/02/instalar-nginx-en-debian-1024x818.png" alt="instalar nginx en debian"   />][4]{.thumbnail}

Usando firebug se puede comprobar que efectivamente se está corriendo un servidor nginx:

[<img src="/assets/img/2013/02/instalar-nginx-en-debian2.png" alt="instalar nginx en debian2"   />][5]{.thumbnail}
