...
<amp-img src="/assets/img/2013/04/gmailStats.png" alt="gmailStats" width="495px" height="244px" />
<amp-img src="/assets/img/2013/04/chart1.png" alt="chart1" width="650px" height="400px" />
<amp-img src="/assets/img/2013/04/chart2.png" alt="chart2" width="650px" height="400px" />
...
<br /><amp-img src="" />< variables.timeOfEmailsReceived.length; i++) { // create
                                                                      // the
                                                                      // rows
    switch (i) {
      case 8:
  ...
  report += "cid:Averageflow\' />" + "<amp-img src="" />< variables.dayOfEmailsReceived.length; i++) { // create
                                                                    // the rows
    dataTable.addRow([
