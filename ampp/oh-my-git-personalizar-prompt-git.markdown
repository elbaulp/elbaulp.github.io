...
<figure>
<a href="/assets/img/Mostrar-Informacion-De-Un-Repositorio-Git-en-El-Prompt-De-Bash.jpg"><amp-img src="/assets/img/Mostrar-Informacion-De-Un-Repositorio-Git-en-El-Prompt-De-Bash.jpg" title="{{ page.title }}" alt="{{ page.title }}" width="823px" height="518px" /></a>
...
<figure>
<a href="/assets/img/ohmygitprompt.png"><amp-img src="/assets/img/ohmygitprompt.png" title="{{ page.title }}" alt="{{ page.title }}" width="527px" height="39px" /></a>
</figure>
