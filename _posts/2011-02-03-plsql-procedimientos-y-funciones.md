...
<pre lang="plsql">CREATE {OR REPLACE} PROCEDURE nombre_proc( param1 [IN | OUT | IN OUT] tipo,... )
IS
...
<pre lang="plsql">CREATE OR REPLACE
...
<pre lang="plsql">CREATE OR REPLACE PROCEDURE today_is AS
BEGIN
...
<pre lang="plsql">CREATE OR REPLACE PROCEDURE today2_is ( fecha DATE ) AS
BEGIN
...
<pre lang="plsql">CREATE {OR REPLACE} FUNCTION nombre_func(param1 tipo,param2 tipo,... ) RETURN tipo_dato IS
  <span class="comentario">-- Declaración de variables locales</span>
BEGIN
  <span class="comentario">-- Instrucciones de ejecución</span>
[EXCEPTION]
