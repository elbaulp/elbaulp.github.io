...
<figure>
<a href="/assets/img/2014/01/CrearDialogoAndroid.png"><amp-img src="/assets/img/2014/01/CrearDialogoAndroid.png" title="{{ page.title }}" alt="{{ page.title }}" width="441px" height="329px" /></a>
</figure>
