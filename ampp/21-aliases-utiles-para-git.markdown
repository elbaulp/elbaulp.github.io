...
---
<figure>
<amp-img src="/assets/img/2013/03/git-logo.png" title="{{ page.title }}" alt="{{ page.title }}" width="910px" height="380px" />
</figure>
...
<figure>
<a href="/assets/img/gitls.png"><amp-img src="/assets/img/gitls.png" title="{{ page.title }}" alt="{{ page.title }}" width="666px" height="504px" /></a>
</figure>
...
<figure>
<a href="/assets/img/gitll.png"><amp-img src="/assets/img/gitll.png" title="{{ page.title }}" alt="{{ page.title }}" width="603px" height="498px" /></a>
</figure>
...
<figure>
<a href="/assets/img/gitlds.png"><amp-img src="/assets/img/gitlds.png" title="{{ page.title }}" alt="{{ page.title }}" width="766px" height="502px" /></a>
</figure>
...
<figure>
<a href="/assets/img/gitld.png"><amp-img src="/assets/img/gitld.png" title="{{ page.title }}" alt="{{ page.title }}" width="785px" height="498px" /></a>
</figure>
