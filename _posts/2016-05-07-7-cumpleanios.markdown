...
<figure>
<a href="/assets/img/7-cumpleanios0.png"><img src="/assets/img/7-cumpleanios0.png" title="{{ page.title }}" alt="{{ page.title }}" width="1024px" height="512px" /></a>
</figure>
...
<figure>
<a href="/assets/img/7-cumpleanios1.png"><img src="/assets/img/7-cumpleanios1.png" title="{{ page.title }}" alt="{{ page.title }}" width="1882px" height="987px" /></a>
</figure>
<figure>
<a href="/assets/img/7-cumpleanios2.png"><img src="/assets/img/7-cumpleanios2.png" title="{{ page.title }}" alt="{{ page.title }}" width="1879px" height="987px" /></a>
</figure>

### WordPress

<figure>
<a href="/assets/img/7-cumpleanios3.png"><img src="/assets/img/7-cumpleanios3.png" title="{{ page.title }}" alt="{{ page.title }}" width="1880px" height="984px" /></a>
</figure>
<figure>
<a href="/assets/img/7-cumpleanios4.png"><img src="/assets/img/7-cumpleanios4.png" title="{{ page.title }}" alt="{{ page.title }}" width="1877px" height="984px" /></a>
</figure>
<figure>
<a href="/assets/img/7-cumpleanios5.png"><img src="/assets/img/7-cumpleanios5.png" title="{{ page.title }}" alt="{{ page.title }}" width="1882px" height="985px" /></a>
</figure>

### Jekyll

<figure>
<a href="/assets/img/7-cumpleanios6.png"><img src="/assets/img/7-cumpleanios6.png" title="{{ page.title }}" alt="{{ page.title }}" width="1134px" height="1046px" /></a>
</figure>
