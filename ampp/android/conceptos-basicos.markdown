...
<figure>
  <a href="/assets/img/android/estructuraCarpetas.png"><amp-img src="/assets/img/android/estructuraCarpetas.png" title="{{ page.title }}" alt="{{ page.title }}" /></a>
</figure>
...
<figure>
  <a href="/assets/img/android/activityLifecycle.png"><amp-img src="/assets/img/android/activityLifecycle.png" title="{{ page.title }}" alt="{{ page.title }}" /></a>
</figure>
