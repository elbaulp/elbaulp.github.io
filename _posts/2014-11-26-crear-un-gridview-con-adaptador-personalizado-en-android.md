...
<figure>
<a href="/assets/img/2014/11/gridview-scrolling-horizontal.png"><img src="/assets/img/2014/11/gridview-scrolling-horizontal.png" title="{{ page.title }}" alt="{{ page.title }}" width="700px" height="350px" /></a>
</figure>
