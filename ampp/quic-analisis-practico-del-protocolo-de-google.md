...
<figure>
<a href="/assets/img/2013/07/Que-es-QUIC-el-nuevo-protocolo-desarrollado-por-Google.png"><amp-img layout="responsive" src="/assets/img/2013/07/Que-es-QUIC-el-nuevo-protocolo-desarrollado-por-Google.png" title="{{ page.title }}" alt="{{ page.title }}" width="468px" height="239px" /></a>
</figure>
...
<figure>
<a href="/assets/img/2014/10/Análisis-práctico-del-protocolo-de-Google-QUIC-primerPaquete.png"><amp-img layout="responsive" src="/assets/img/2014/10/Análisis-práctico-del-protocolo-de-Google-QUIC-primerPaquete.png" title="{{ page.title }}" alt="{{ page.title }}" width="370px" height="118px" /></a>
</figure>
...
<figure>
<a href="/assets/img/2014/10/Análisis-práctico-del-protocolo-de-Google-QUIC-CapturaQUIC.png"><amp-img layout="responsive" src="/assets/img/2014/10/Análisis-práctico-del-protocolo-de-Google-QUIC-CapturaQUIC.png" title="{{ page.title }}" alt="{{ page.title }}" width="1920px" height="1080px" /></a>
</figure>
...
<figure>
<a href="/assets/img/2014/10/Análisis-práctico-del-protocolo-de-Google-QUIC-quicVersion.png"><amp-img layout="responsive" src="/assets/img/2014/10/Análisis-práctico-del-protocolo-de-Google-QUIC-quicVersion.png" title="{{ page.title }}" alt="{{ page.title }}" width="594px" height="244px" /></a>
</figure>
...
<figure>
<a href="/assets/img/2014/10/Análisis-práctico-del-protocolo-de-Google-QUIC-quicOtrosPaquetes.png"><amp-img layout="responsive" src="/assets/img/2014/10/Análisis-práctico-del-protocolo-de-Google-QUIC-quicOtrosPaquetes.png" title="{{ page.title }}" alt="{{ page.title }}" width="596px" height="246px" /></a>
</figure>
