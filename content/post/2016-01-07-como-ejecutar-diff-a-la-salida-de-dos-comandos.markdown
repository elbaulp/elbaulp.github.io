---
color: '#E64A19'
date: 2016-01-07T12:54:12Z
description: Recientemente necesité ejecutar el comando `diff` sobre la salida de
  otros dos comandos. Es decir, `diff` recibe como parámetros los ficheros sobre los
  que se quiere mostrar las diferencias, pero yo buscaba hacer un `diff` a la salida
  de dos comandos, no dos ficheros.
...
url: /2016/01/07/como-ejecutar-diff-a-la-salida-de-dos-comandos/
---
