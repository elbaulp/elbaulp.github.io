...
<pre>ptro_pt=new Punto('*', 20, 10); <span class="comentarios">//primer constructor</span>
...
<pre>puntero_a_objeto->miembro_público;
</pre>
...
<pre>delete ptro_pt;   <span class="comentarios">//llama al destructor</span>
</pre>
