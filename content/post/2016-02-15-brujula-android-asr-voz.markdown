...
description: 'Enunciado: se debe identificar mediante interfaz vocal un punto cardinal
  ...
  del punto, solo el número, por ejemplo “Norte diez”. Una vez reconocido el patrón
  vocal se debe mostrar una brújula para que el usuario se oriente en la dirección
...
url: /2016/02/15/brujula-android-asr-voz/
---
