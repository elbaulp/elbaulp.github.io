...
categories: LaTeX
color: '#B31917'
date: 2016-09-16T15:48:53Z
description: Breve introducción al paquete PgfGantt de LaTeX, para crear diagramas
  de Gantt
image: crear-diagrama-de-gantt-en-latex.png
introduction: Breve introducción al paquete PgfGantt de LaTeX, para crear diagramas
  de Gantt
main-class: latex
tags:
- latex
