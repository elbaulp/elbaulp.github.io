...
<figure>
  <a href="/assets/img/2014/01/iconoAndroid.png"><amp-img src="/assets/img/2014/01/iconoAndroid.png" title="{{ page.title }}" alt="{{ page.title }}" /></a>
</figure>
...
<figure>
  <a href="/assets/img/android/layouthelloworldandroid.png"><amp-img src="/assets/img/android/layouthelloworldandroid.png" title="{{ page.title }}" alt="{{ page.title }}" /></a>
</figure>
