...
tags:
  ...
  - usb
---
[<img src="http://elbauldelprogramador.com/content/uploads/2012/05/Oxford-Nanopore-MinION1.jpeg" alt="" title="Oxford-Nanopore-MinION" width="660" height="440" class="aligncenter size-full wp-image-754" />][1]  
¿Qué pasaría si pudieras poner algunas células bacterianas en un dispositivo USB, conectarlo a su laptop, y obtener una secuencia completa de ADN en cuestión de minutos?  
...
<div class="sharedaddy">
  <div class="sd-content">
    <ul>
      <li>
        <a class="hastip" rel="nofollow" href="http://twitter.com/home?status=¿Se puede realmente secuenciar ADN con un dispositivo USB?+http://elbauldelprogramador.com/se-puede-realmente-secuenciar-adn-con-un-dispositivo-usb/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Twitter" target="_blank"><span class="iconbox-title"><i class="icon-twitter icon-2x"></i></span></a>
      </li>
      <li>
        <a class="hastip" rel="nofollow" href="http://www.facebook.com/sharer.php?u=http://elbauldelprogramador.com/se-puede-realmente-secuenciar-adn-con-un-dispositivo-usb/&t=¿Se puede realmente secuenciar ADN con un dispositivo USB?+http://elbauldelprogramador.com/se-puede-realmente-secuenciar-adn-con-un-dispositivo-usb/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Facebook" target="_blank"><span class="iconbox-title"><i class="icon-facebook icon-2x"></i></span></a>
      </li>
      <li>
        <a class="hastip" rel="nofollow" href="https://plus.google.com/share?url=¿Se puede realmente secuenciar ADN con un dispositivo USB?+http://elbauldelprogramador.com/se-puede-realmente-secuenciar-adn-con-un-dispositivo-usb/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en G+" target="_blank"><span class="iconbox-title"><i class="icon-google-plus icon-2x"></i></span></a>
      </li>
    </ul>
  </div>
</div>
...
<div class="iconsc hastip" title="Feed RSS">
 ...
 [1]: http://elbauldelprogramador.com/content/uploads/2012/05/Oxford-Nanopore-MinION1.jpeg
