...
description: 'Haciendo una práctica de Aprendizaje Automático, en concreto implementando
  ...
  Logística e intentando hacer el código lo más eficiente posible (Y eso en R significa
  evitar el uso de for a toda costa) me encontré con la siguiente situación:'
...
url: /2016/04/22/acceder-variable-dentro-funcion-r/
---
