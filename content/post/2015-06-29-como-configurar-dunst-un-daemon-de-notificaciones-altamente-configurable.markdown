...
categories: null
color: '#F57C00'
date: 2015-06-29T18:43:06Z
description: Hoy quiero hablaros de dunst, un demonio de notificaciones que me instalé
...
url: /2015/06/29/como-configurar-dunst-un-daemon-de-notificaciones-altamente-configurable/
---

<figure>
<amp-img on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="/assets/img/Como-Configurar-Dunst,-un-daemon-de-notificaciones-altamente-configurable.png" title="{{ page.title }}" alt="{{ page.title }}" width="329px" height="212px" />
</figure>
