...
color: "#0097A7"
---
<amp-img src="/assets/img/2013/02/nginx-logo.png" alt="instalar y configurar nginx" width="350px" height="90px" />  
...
[<amp-img src="/assets/img/2013/02/instalar-nginx-en-debian-1024x818.png" alt="instalar nginx en debian" width="1024px" height="818px" />][4]{.thumbnail}

Usando firebug se puede comprobar que efectivamente se está corriendo un servidor nginx:

[<amp-img src="/assets/img/2013/02/instalar-nginx-en-debian2.png" alt="instalar nginx en debian2" width="641px" height="150px" />][5]{.thumbnail}
