---
color: '#B31917'
date: 2015-12-09T16:55:32Z
description: En este artículo veremos cómo podemos definir colores personalizados
...
url: /2015/12/09/como-definir-colores-personalizados-en-latex/
---
...
<figure>
<a href="/assets/img/xcolorlatex1.png"><amp-img on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="/assets/img/xcolorlatex1.png" title="{{ page.title }}" alt="{{ page.title }}" width="300px" height="154px" /></a>
...
<figure>
<a href="/assets/img/xcolorlatex2.png"><amp-img on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="/assets/img/xcolorlatex2.png" title="{{ page.title }}" alt="{{ page.title }}" width="300px" height="142px" /></a>
<span class="image-credit">Crédito de la imagen: texblog.org</span>
</figure>
...
<figure>
<a href="/assets/img/xcolorlatex3.png"><amp-img on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="/assets/img/xcolorlatex3.png" title="{{ page.title }}" alt="{{ page.title }}" width="300px" height="156px" /></a>
<span class="image-credit">Crédito de la imagen: texblog.org</span>
</figure>
...
<figure>
<a href="/assets/img/latexxcolorbrillantes.png"><amp-img on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="/assets/img/latexxcolorbrillantes.png" title="{{ page.title }}" alt="{{ page.title }}" width="1024px" height="291px" /></a>
<span class="image-credit">Crédito de la imagen: texblog.org</span>
</figure>
