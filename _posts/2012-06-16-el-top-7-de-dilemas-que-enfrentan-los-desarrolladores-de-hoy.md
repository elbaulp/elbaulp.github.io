...
excerpt: |
  ...
  <!--
  [Considere<a href="http://www.infoworld.com/d/application-development/7-programming-myths-busted-190890?source=fssr"> Los 7 mitos de la programación, e instrúyase con <a href="http://www.infoworld.com/d/application-development/10-hard-truths-developers-must-learn-accept-189620?source=fssr">Las 10 duras verdades que los desarrolladores deben aceptar</a>. | Pruebe sus conocimientos de programación con nuestros tests IQ sobre programación: <a href="http://www.infoworld.com/d/developer-world/programming-iq-test-round-1-166?source=fssr">Round 1</a> y <a href="http://www.infoworld.com/d/adventures-in-it/programming-iq-test-round-2-224?source=fssr">Round 2</a> y <a href="http://www.infoworld.com/d/application-development/hello-world-programming-languages-quiz-188874?source=fssr">"¡Hello, world": Preguntas sobre lenguajes de programación</a>. | Manténgase informado sobre las perspectivas claves para el desarrollo de aplicaciones con el boletín <a href="http://www.infoworld.com/newsletters/subscribe?showlist=infoworld_developer&amp;source=ifwelg_fssr">Developer World</a>. ]-->
...
<div>
  <div>
    ...
    <p dir="ltr">
      ...
      <p>
        <strong>Dilema nº 5: SQL vs NoSQL</strong>
      </p>
      ...
      <div>
        ...
        <p>
          <strong>Dilema n°6: Elegir entre Native o Web mobile</strong>
        </p>
        ...
        <p>
          <strong>Dilema n°7: ¿Cuánto control deberían realmente tener los usuarios?</strong>
        </p>
      ...
      <div class="sharedaddy">
        <div class="sd-content">
          <ul>
            <li>
              <a class="hastip" rel="nofollow" href="http://twitter.com/home?status=El Top 7 de dilemas que enfrentan los desarrolladores de hoy+http://elbauldelprogramador.com/el-top-7-de-dilemas-que-enfrentan-los-desarrolladores-de-hoy/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Twitter" target="_blank"><span class="iconbox-title"><i class="icon-twitter icon-2x"></i></span></a>
            </li>
            <li>
              <a class="hastip" rel="nofollow" href="http://www.facebook.com/sharer.php?u=http://elbauldelprogramador.com/el-top-7-de-dilemas-que-enfrentan-los-desarrolladores-de-hoy/&t=El Top 7 de dilemas que enfrentan los desarrolladores de hoy+http://elbauldelprogramador.com/el-top-7-de-dilemas-que-enfrentan-los-desarrolladores-de-hoy/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Facebook" target="_blank"><span class="iconbox-title"><i class="icon-facebook icon-2x"></i></span></a>
            </li>
            <li>
              <a class="hastip" rel="nofollow" href="https://plus.google.com/share?url=El Top 7 de dilemas que enfrentan los desarrolladores de hoy+http://elbauldelprogramador.com/el-top-7-de-dilemas-que-enfrentan-los-desarrolladores-de-hoy/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en G+" target="_blank"><span class="iconbox-title"><i class="icon-google-plus icon-2x"></i></span></a>
            </li>
          </ul>
        </div>
      </div>
