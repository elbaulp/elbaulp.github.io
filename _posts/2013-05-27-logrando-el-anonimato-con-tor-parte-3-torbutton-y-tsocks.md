...
#### [<img class="alignnone size-medium wp-image-1536" alt="081712_1515_AchievingAn1" src="http://elbauldelprogramador.com/content/uploads/2013/04/081712_1515_AchievingAn1-300x114.png" width="300" height="114" />][4]{.thumbnail}
...
[<img class="alignnone size-medium wp-image-1575" alt="081712_1515_AchievingAn2" src="http://elbauldelprogramador.com/content/uploads/2013/05/081712_1515_AchievingAn2-300x99.png" width="300" height="99" />][5]{.thumbnail}
...
<div class="sharedaddy">
  <div class="sd-content">
    <ul>
      <li>
        <a class="hastip" rel="nofollow" href="http://twitter.com/home?status=Logrando el anonimato con Tor (Parte 3) : Torbutton y Tsocks+http://elbauldelprogramador.com/logrando-el-anonimato-con-tor-parte-3-torbutton-y-tsocks/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Twitter" target="_blank"><span class="iconbox-title"><i class="icon-twitter icon-2x"></i></span></a>
      </li>
      <li>
        <a class="hastip" rel="nofollow" href="http://www.facebook.com/sharer.php?u=http://elbauldelprogramador.com/logrando-el-anonimato-con-tor-parte-3-torbutton-y-tsocks/&t=Logrando el anonimato con Tor (Parte 3) : Torbutton y Tsocks+http://elbauldelprogramador.com/logrando-el-anonimato-con-tor-parte-3-torbutton-y-tsocks/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Facebook" target="_blank"><span class="iconbox-title"><i class="icon-facebook icon-2x"></i></span></a>
      </li>
      <li>
        <a class="hastip" rel="nofollow" href="https://plus.google.com/share?url=Logrando el anonimato con Tor (Parte 3) : Torbutton y Tsocks+http://elbauldelprogramador.com/logrando-el-anonimato-con-tor-parte-3-torbutton-y-tsocks/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en G+" target="_blank"><span class="iconbox-title"><i class="icon-google-plus icon-2x"></i></span></a>
      </li>
    </ul>
  </div>
</div>
...
<div class="iconsc hastip" title="Feed RSS">
 ...
 [4]: http://elbauldelprogramador.com/content/uploads/2013/04/081712_1515_AchievingAn1.png
 [5]: http://elbauldelprogramador.com/content/uploads/2013/05/081712_1515_AchievingAn2.png