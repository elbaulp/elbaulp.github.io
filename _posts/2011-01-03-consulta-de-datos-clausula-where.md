...
<pre lang="sql">WHERE &lt;search_condition></pre>
...
<pre lang="sql">Columna o Expresión [Not] Between valor1 And valor2</pre>
...
<pre lang="sql">expresión_a_comparar [ NOT ] LIKE patrón</pre>
...
<table class="tabla">
  ...
  <tr>
    ...
    <pre lang="sql">expresion [ NOT ] IN ( subconsulta | expresion o valor [ ,...n ])</pre>
