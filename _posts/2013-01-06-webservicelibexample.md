...
<pre lang="java">RestRequest rq = new JSONRestRequest();
...
<pre lang="java">public class MainActivity extends Activity implements AsyncTaskCompleteListener&lt;RestResponse>
</pre>
...
<pre lang="java">RestRequest apiWordpress = new JSONRestRequest();
...
<pre lang="java">package com.elbauldelprogramador.webservicelibexample;
