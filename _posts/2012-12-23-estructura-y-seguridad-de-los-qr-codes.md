...
<img src="http://elbauldelprogramador.com/content/uploads/2012/12/linkentrada2-300x300.png" alt="QR Code" width="300" height="300" class="thumbnail alignleft size-medium wp-image-1063" />
...
<img src="http://elbauldelprogramador.com/content/uploads/2012/12/qrbaultargetdownright2.png" alt="qrbaultargetdownright" width="280" height="280" class="thumbnail aligncenter size-full wp-image-1060" />
...
<img src="http://elbauldelprogramador.com/content/uploads/2012/12/qrbaulinnercorners2.png" alt="qrbaulinnercorners" width="280" height="280" class="thumbnail aligncenter size-full wp-image-1061" />
...
<img src="http://elbauldelprogramador.com/content/uploads/2012/12/Custom_QR_code_Wikipedia2.png" alt="Custom_QR_code_Wikipedia" width="564" height="396" class="thumbnail aligncenter size-full wp-image-1062" />
...
<div class="sharedaddy">
  <div class="sd-content">
    <ul>
      <li>
        <a class="hastip" rel="nofollow" href="http://twitter.com/home?status=Estructura y seguridad de los QR Codes+http://elbauldelprogramador.com/estructura-y-seguridad-de-los-qr-codes/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Twitter" target="_blank"><span class="iconbox-title"><i class="icon-twitter icon-2x"></i></span></a>
      </li>
      <li>
        <a class="hastip" rel="nofollow" href="http://www.facebook.com/sharer.php?u=http://elbauldelprogramador.com/estructura-y-seguridad-de-los-qr-codes/&t=Estructura y seguridad de los QR Codes+http://elbauldelprogramador.com/estructura-y-seguridad-de-los-qr-codes/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Facebook" target="_blank"><span class="iconbox-title"><i class="icon-facebook icon-2x"></i></span></a>
      </li>
      <li>
        <a class="hastip" rel="nofollow" href="https://plus.google.com/share?url=Estructura y seguridad de los QR Codes+http://elbauldelprogramador.com/estructura-y-seguridad-de-los-qr-codes/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en G+" target="_blank"><span class="iconbox-title"><i class="icon-google-plus icon-2x"></i></span></a>
      </li>
    </ul>
  </div>
</div>
