...
categories: null
color: '#2196F3'
date: 2016-07-18T18:08:56Z
description: null
image: imagen-terminal-color-texto-a-juego-linux.png
introduction: Con este pequeño script podrás cambiar el fondo y color de texto de
  tu terminal, a juego
main-class: linux
tags:
- Terminal
- Gnome
- Imágenes
title: Cambia La Imágen De Fondo Del Terminal Gnome Y Pon Un Color De Texto a Juego,
  Automáticamente
url: /2016/07/18/imagen-terminal-color-texto-a-juego-linux/
---
