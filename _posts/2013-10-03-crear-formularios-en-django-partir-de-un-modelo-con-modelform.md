...
---
<img src="http://elbauldelprogramador.com/content/uploads/2013/10/django.png" alt="Crear formularios en Django a partir de un Modelo con ModelForm" width="700" height="394" class="thumbnail aligncenter size-full wp-image-1925" />
...
<pre lang="bash">$ python manage.py startapp pruebaformularios
</pre>
...
<pre lang="python">PROJECT_PATH = os.path.split(os.path.abspath(os.path.dirname(__file__)))[0]
</pre>
...
<pre lang="python"># pruebaformularios/urls.py
...
<pre lang="python"># Fichero urls.py del proyecto
from django.conf.urls import patterns
...
<pre lang="bash">$ python manage.py syncdb
...
<img src="http://elbauldelprogramador.com/content/uploads/2013/10/Crear-formularios-en-Django-a-partir-de-un-Modelo-con-ModelForm.png" alt="Crear formularios en Django a partir de un Modelo con ModelForm" width="161" height="153" class="thumbnail aligncenter size-full wp-image-1927" />
