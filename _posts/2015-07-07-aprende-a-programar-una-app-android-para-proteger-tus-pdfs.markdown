...
<figure>
  <img src="/images/Aprende a Programar Una App Android Para Proteger Tus PDFs.jpg" title="{{ title }}" alt="{{ title }}" />
</figure>
...
<figure>
  <img src="/images/Protege tus documentos PDF nativos.jpg" title="{{ title }}" alt="{{ title }}" />
</figure>
...
<figure>
  <img src="/images/Documento protegido por user password.jpg" title="{{ title }}" alt="{{ title }}" />
</figure>
