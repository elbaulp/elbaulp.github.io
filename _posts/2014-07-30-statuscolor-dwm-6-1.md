...
<figure>
<a href="/assets/img/2014/07/simplestatuscolor-in-dwmstatus-dwm6.1.png"><img src="/assets/img/2014/07/simplestatuscolor-in-dwmstatus-dwm6.1.png" title="{{ page.title }}" alt="{{ page.title }}" width="702px" height="13px" /></a>
</figure>
