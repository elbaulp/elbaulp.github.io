...
<pre lang="java" >private static final String TAG = "SimpleServer";
...
<pre lang="java">startTelnetSession()</pre>

es el que está implementado en C y por ello se declara como 

<pre lang="java">public native String startTelnetSession();</pre>
...
<pre lang="c">jstring Java_com_elbauldelprogramador_simpleserver_MainActivity_startTelnetSession()</pre>

que será llamado desde la activity principal y simplemente llama al método 

<pre lang="c">char *startServer()</pre>
...
<pre lang="make">LOCAL_PATH := $(call my-dir)
...
<pre lang="bash">ndk-build &#038;&#038; ant debug &#038;&#038; adb install -r bin/MainActivity-debug.apk
</pre>
...
<pre lang="bash">ndk-gdb --start --verbose
</pre>
...
<pre lang="bash">$ telnet 192.168.1.34 7890
Trying 192.168.1.34...
...
<pre lang="bash">ip_de elbauldelprogramador.com
</pre>

Al pulsar enter, se detiene la ejecución del programa debido al *breakpoint* en la línea 21

<pre lang="bash">Breakpoint 1, addToLog (log=0x54b38c1c "", new_entry=0x54b3881c "ip_de elbauldelprogramador.com\r\n") at jni/sServer.c:21
...
<pre lang="bash">ip_de gooip_de google.com
...
<pre lang="bash">(gdb) x /2s command_log
...
<div class="sharedaddy">
  <div class="sd-content">
    <ul>
      <li>
        <a class="hastip" rel="nofollow" href="http://twitter.com/home?status=NDK-gdb &#8211; Depurar aplicaciones en el NKD de Android+http://elbauldelprogramador.com/ndk-gdb-depurar-aplicaciones-en-el-nkd-de-android/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Twitter" target="_blank"><span class="iconbox-title"><i class="icon-twitter icon-2x"></i></span></a>
      </li>
      <li>
        <a class="hastip" rel="nofollow" href="http://www.facebook.com/sharer.php?u=http://elbauldelprogramador.com/ndk-gdb-depurar-aplicaciones-en-el-nkd-de-android/&t=NDK-gdb &#8211; Depurar aplicaciones en el NKD de Android+http://elbauldelprogramador.com/ndk-gdb-depurar-aplicaciones-en-el-nkd-de-android/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en Facebook" target="_blank"><span class="iconbox-title"><i class="icon-facebook icon-2x"></i></span></a>
      </li>
      <li>
        <a class="hastip" rel="nofollow" href="https://plus.google.com/share?url=NDK-gdb &#8211; Depurar aplicaciones en el NKD de Android+http://elbauldelprogramador.com/ndk-gdb-depurar-aplicaciones-en-el-nkd-de-android/+V%C3%ADa+%40elbaulp" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Compartir en G+" target="_blank"><span class="iconbox-title"><i class="icon-google-plus icon-2x"></i></span></a>
      </li>
    </ul>
  </div>
</div>
