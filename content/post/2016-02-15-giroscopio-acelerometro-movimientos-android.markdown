...
categories: null
color: '#D32F2F'
date: 2016-02-15T09:32:53Z
description: Una appMovimientoSonido que reconozca un patrón de movimientos de vuestra
  elección usando el giroscopio y/o el acelerómetro, una vez detectado el patrón,
...
url: /2016/02/15/giroscopio-acelerometro-movimientos-android/
---
...
<figure>
<a href="/assets/img/npi/movementSound.png"><amp-img on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="/assets/img/npi/movementSound.png" title="Aplicación Movement Sound" alt="Aplicación Movement Sound" width="338px" height="600px" /></a>
